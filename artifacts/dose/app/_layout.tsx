...
import { initializeUnityAds, loadInterstitial, loadSaveButtonAd, loadTimedAd, showTimedAd } from "@/services/unity-ads";
...
export default function RootLayout() {
  ...
  useEffect(() => {
    if (Platform.OS !== "web") {
      initializeUnityAds()
        .then(() => Promise.all([loadInterstitial(), loadSaveButtonAd(), loadTimedAd()]))
        .catch(() => {});
    }
  }, []);
